...
public class connect_2675ProvisioningConnectorConfig {

    private static final Log log = LogFactory.getLog(connect_2675ProvisioningConnectorConfig.class);
    private Properties configs;

    public connect_2675ProvisioningConnectorConfig(Properties configs) {
